...
export default class MagicLinkPage extends React.Component {
    ...
    renderFormHeader() {
        let popupTitle = `Wysłałem Ci linka do logowania!`;
        let popupDescription = `Jeśli email nie dotrze do Ciebie w ciągu 3 minut, sprawdź folder "spam"!`;

        if (this.context.lastPage === 'signup') {
            popupTitle = `Teraz sprawdź maila!`;
            popupDescription = `Aby potwierdzić subskrypcję, kliknij w linka znajdującego się w mailu. Jeśli email nie dotrze do Ciebie w ciągu 3 minut, sprawdź folder "spam"!`;
        }
